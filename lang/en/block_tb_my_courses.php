...
/**
 * Lang strings for tb_my_courses block
 *
...
$string['tb_my_courses:addinstance'] = 'Add a new Leeloo LXP MY Courses block';
$string['tb_my_courses:myaddinstance'] = 'Add a new Leeloo LXP MY Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP MY Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP MY Courses';
$string['displayname'] = 'Leeloo LXP MY Courses';
...
$string['tb_my_courses_bgimage'] = "Embed images into background";
$string['tb_my_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP MY Courses (tb_my_courses) block only shows information about courses and does not store data itself.';

$string['blocktitle'] = 'Leeloo LXP MY Courses';
